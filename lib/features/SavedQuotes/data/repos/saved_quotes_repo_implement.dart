...
import 'package:starter_template/features/SavedQuotes/data/repos/saved_quotes_repo.dart';

class SavedQuotesRepoImplement implements SavedQuotesRepo {
  @override
  Future<Either<Failures, void>> saveQuote(
      {required SavedQuotesModel quote}) async {
    try {
